...
1. install the MS SQL driver that is compatible with their SQL server version. Details about this installation process can be found in the **vignette**.    
2. create a credentials file where the credential will be stored. Use the `show_example_file()` to see a template of this file.     
...
## Vignette
The vignette of the **readepi** contains detailed illustration about the used of each function. This can be accessed by typing the command below:      
```{r eval=FALSE}
