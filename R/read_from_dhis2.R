...
read_from_dhis2 <- function(base.url,
  ...
  checkmate::assertCharacter(id.col.name, len = 1L, null.ok = TRUE,
                             any.missing = FALSE)
  checkmate::assertCharacter(base.url, len = 1L, null.ok = FALSE,
                             any.missing = FALSE)
  checkmate::assertCharacter(user.name, len = 1L, null.ok = FALSE,
                             any.missing = FALSE)
  ...
  attributes = check_dhis2_attributes(user.name,
                                      password,
                                      base.url,
                                      dataset,
                                      organisation.unit,
  ...
  data = data %>% dplyr::left_join(tmp.data.elt, by="dataElement") %>%
