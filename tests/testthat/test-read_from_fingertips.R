test_that("read_from_fingertips works", {
  data = read_from_fingertips(indicator_id=90362, indicator_name="Healthy life expectancy at birth",
  ...
  data = read_from_fingertips(indicator_id=c(90362, 90283), indicator_name=NULL,
                              area_type_id=202, parent_area_type_id=NULL,
                              profile_id=NULL, profile_name=NULL,
                              domain_id=NULL, domain_name=NULL,
                              fields=NULL, records=NULL,
  ...
  data = read_from_fingertips(indicator_id=90362, indicator_name=NULL,
                              ...
                              id.position=NULL, id.column.name="AreaCode"
  )
  expect_type(data, type = "list")
  expect_length(data, 1)
  expect_named(data, "data")
...
test_that("read_from_fingertips works when only indicator name is provided", {
  data = read_from_fingertips(indicator_id=NULL, indicator_name="Pupil absence",
                              area_type_id=202, parent_area_type_id=NULL,
                              profile_id=NULL, profile_name=NULL,
...
test_that("read_from_fingertips fails with bad indicator ID", {
  expect_error(
    data = read_from_fingertips(indicator_id=NA, indicator_name=NULL,
                              area_type_id=202, parent_area_type_id=NULL,
                              profile_id=NULL, profile_name=NULL,
                              domain_id=NULL, domain_name=NULL,
                              fields=NULL, records=NULL,
...
test_that("read_from_fingertips fails with bad indicator name", {
  expect_error(
    data = read_from_fingertips(indicator_id=90362, indicator_name=NA,
                                area_type_id=202, parent_area_type_id=NULL,
                                profile_id=NULL, profile_name=NULL,
                                domain_id=NULL, domain_name=NULL,
                                fields=NULL, records=NULL,
