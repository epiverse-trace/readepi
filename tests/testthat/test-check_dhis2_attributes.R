test_that("check_dhis2_attributes works as expected", {
  attributes = check_dhis2_attributes(username="admin",
                                      password="district",
  ...
  expect_named(attributes, c("dataset", "dataset_details", "organisation_unit",
...
test_that("check_dhis2_attributes fails as expected", {
  expect_error(
    attributes = check_dhis2_attributes(username=NULL,
                                        password="district",
                                        base.url="https://play.dhis2.org/dev/",
                                        dataset="pBOMPrpg1QX",
                                        organisation.unit="DiszpKrYNg8",
