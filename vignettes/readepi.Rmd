...
fields <- "author_id,name,last_name,initials" # same as fields = "author_id, name, last_name, initials" and fields = c("author_id", "name", "last_name", "initials")
data <- readepi(credentials.file,
  project.id = "Rfam",
  driver.name = "",
  table.name = "author",
...
records <- "1,34,15,70,118,20" # same as records=c("1", "34", "15", "70", "118", "20") and records = "1, 34, 15, 70, 118, 20"
data <- readepi(credentials.file,
  project.id = "Rfam",
  driver.name = "",
  table.name = "author",
...
data <- readepi(
  indicator_name = "A. Overarching indicators",
  area_type_id = 202
)
