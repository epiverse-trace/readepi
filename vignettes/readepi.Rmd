...
fields <- "date,sex,age" # same as fields = "date, sex, age" and fields = c("date","sex","age")
data <- readepi(credentials.file,
  project.id = "TEST_READEPI",
  driver.name = "ODBC Driver 17 for SQL Server",
  table.name = "covid",
...
records <- "e38000028,e38000030,e38000222,e38000051,e38000057,e38000143" # same as records=c("e38000028","e38000030","e38000222","e38000051","e38000057","e38000143") and records = "e38000028, e38000030, e38000222, e38000051, e38000057, e38000143"
data <- readepi(credentials.file,
  project.id = "TEST_READEPI",
  driver.name = "ODBC Driver 17 for SQL Server",
  table.name = "covid",
...
table.names <- "covid, ebola, iris"
fields <- c(
  "date,sex,age,ccg_code", "case_id,date_of_infection,gender",
...
records <- c(
  "e38000028,e38000030,e38000222,e38000051,e38000057,e38000143",
