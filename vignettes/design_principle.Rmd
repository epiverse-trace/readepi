...
3. The `get_metadata()` function takes two arguments: a **credential** object and an **api** object. Both are defined in the paragraphs above. It returns a data frame with the details about the structure of the data.
