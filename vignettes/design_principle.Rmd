...
connection is crucial for ensuring successful data import. However, the
authentication is not required when importing data from SORMAS.
...
-   `read_sormas()`: for importing data from SORMAS. It takes the
    following arguments:
    -   **base_url**: A character with the base URL to the target SORMAS
        system
