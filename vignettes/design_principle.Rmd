...
In the next versions, the `read_epidata()` function will also allow data import from HIS like <span style="color: orange;">GoData, Globaldothealth, SORMAS, and ODK</span>. It will also include functionalities for importing data from RDBMS such as <span style="color: orange;">MS ACCESS, and SQlite</span>.
:::
